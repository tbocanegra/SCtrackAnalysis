...
%   (year,month,day) arrays. Y, MO, and D must be arrays of the same size
...
%   arguments must be arrays of the same size (or any can be a scalar).
%   
%   Limitations: 
...
%   $Revision: 1.1.6.1 $  $Date: 2006/04/20 17:45:05 $

mjd = juliandate( varargin{:} ) - 2400000.5; 
